...
const (
	GetUserService_GetUserByID_FullMethodName = "/user.GetUserService/GetUserByID"
)
...
func (c *getUserServiceClient) GetUserByID(ctx context.Context, in *GetUserByIDRequest, opts ...grpc.CallOption) (*GetUserByIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserByIDResponse)
	err := c.cc.Invoke(ctx, GetUserService_GetUserByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGetUserServiceServer must be embedded to have
...
func (UnimplementedGetUserServiceServer) GetUserByID(context.Context, *GetUserByIDRequest) (*GetUserByIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserByID not implemented")
}
func (UnimplementedGetUserServiceServer) mustEmbedUnimplementedGetUserServiceServer() {}
func (UnimplementedGetUserServiceServer) testEmbeddedByValue()                        {}
...
func RegisterGetUserServiceServer(s grpc.ServiceRegistrar, srv GetUserServiceServer) {
	// If the following call pancis, it indicates UnimplementedGetUserServiceServer was
...
func _GetUserService_GetUserByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserByIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GetUserServiceServer).GetUserByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GetUserService_GetUserByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GetUserServiceServer).GetUserByID(ctx, req.(*GetUserByIDRequest))
	}
...
var GetUserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.GetUserService",
	HandlerType: (*GetUserServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetUserByID",
			Handler:    _GetUserService_GetUserByID_Handler,
		},
	},
